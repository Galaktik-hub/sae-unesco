...
<html>
    ...
    <body>
        <header>
            <nav id="nav" class="">
                <div class="titre">
                    <a href="accueil.php?lang=fr">MEMPHIS</a>
                </div>
                <ul class="menu">
                    ...
                    <a href="architecture.php?lang=fr" class="page">
                        <li class="menu-item">
                    ...
                    <div class="line"></div>
                    <a href="histoire.php?lang=fr" class="page">
                        <li class="menu-item">
                    ...
                    <div class="line"></div>
                    <a href="activites.php?lang=fr" class="page">
                        <li class="menu-item">
                    ...
                    <div class="line"></div>
                    <a href="infos.php?lang=fr" class="page">
                        <li class="menu-item">
